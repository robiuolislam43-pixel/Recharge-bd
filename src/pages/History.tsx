                  ...
                  <div className="flex items-start gap-4 sm:gap-5">
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="flex items-center gap-1.5 px-2 py-0.5 bg-slate-100 text-slate-600 text-[8px] sm:text-[10px] font-black uppercase tracking-widest rounded-lg">
                          <div className="w-3 h-3 rounded-sm overflow-hidden bg-white p-0.5">
                            <img 
                              src={OPERATOR_DATA[order.operator as Operator]?.logo} 
                              alt={order.operator} 
                              className="w-full h-full object-contain"
